...
export function ContextFilesPicker() {
  // const { settings } = useSettings(); // Removed: unused
  const {
    contextPaths,
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-[300px]">
                    <p>
                      ...
                      context. You can also manually specify files below.
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
          ...
          <TooltipProvider>
            {contextPaths.length > 0 ? (
              ...
              <div className="rounded-md border border-dashed p-4 text-center">
                <p className="text-sm text-muted-foreground">
                  Dyad will use Smart Context to automatically find the most
                  relevant files to use as context.
                </p>
              </div>
            )}
          </TooltipProvider>
              ...
              <p className="text-sm text-muted-foreground">
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-[300px]">
                      <p>
                        Auto-include files are always included in the context in
                        addition to the files selected as relevant by Smart
                        Context.
                      </p>
                    </TooltipContent>
                  </Tooltip>
